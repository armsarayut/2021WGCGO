...
{
    public class BOOKING_NOTE_ITEMS
    {
		...
		public string BOOKING_MODEL_NO { get; set; }
		public DateTime? REQUEST_DATE { get; set; }
		public decimal? SEQ_TR { get; set; }
		public string TANK_SIZE { get; set; }
		public string HUMAN_DRIVE_CODE { get; set; }
		public string TIME_LOAD_PRODUCT { get; set; }
