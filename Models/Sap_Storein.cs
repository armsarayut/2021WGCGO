...
namespace GoWMS.Server.Models
{
    public class Sap_Storein
    {
        ...
        private decimal? m_net_weight;
        public decimal? Net_Weight { get => m_net_weight; set => m_net_weight = value; }
        ...
        private string m_store_table;
        public string Store_Table { get => m_store_table; set => m_store_table = value; }

        private string m_sap_su;
        public string Sap_Su { get => m_sap_su; set => m_sap_su = value; }
